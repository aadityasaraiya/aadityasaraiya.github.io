...
+ Estimate the relative camera poses (XYZ position) for different frames in a moving camera. 

+ Estimate the geometry (3-D model) of the environment based on the camera frames.  
